...
// 1. Définition propre des en-têtes CORS pour qu'ils soient réutilisables
const corsHeaders = {
...
Deno.serve(async (req) => {
    // 2. Gestion explicite du pré-contrôle OPTIONS (Preflight)
    ...
    try {
        ...
        // IMPORTANT : Même l'erreur doit renvoyer les headers CORS
